...
$delete_other_device_id=$_POST['delete_other_device_id'];

$delete_device_sql=manage("DELETE FROM other_devices WHERE id=?",array(htmlspecialchars($delete_other_device_id)));
...
$logs_result = manage("INSERT INTO logs (computer_name,ip_address,page,action,details,date) 
                ...
                <p>ID: <span class='font-weight-bold'>".$delete_other_device_id."</span></p>
